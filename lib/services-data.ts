...
export const services: Service[] = [
  ...
  },
  {
    ...
    tools:
      "Google Ads, Facebook, Instagram, and other digital channels.",
    trialNote:
  ...
  },
  {
    ...
    tools:
      "Python, Java, C++, C#, JavaScript, React, Node.js, and more.",
    trialNote:
